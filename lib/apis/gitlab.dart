...
class GitLab implements GitHost {
    // TODO: move this clienID to .env
    static const _clientID = "faf33c3716faf05bfb701b1b31e36c83a23c3ec2d7161f4ff00fba2275524d09";
    ...
    void init(OAuthCallback callback) {
        Future _handleMessages(MethodCall call) async {
            ...
            var queryParameters = url.substring(url.indexOf('#') + 1);
            var map = Uri.splitQueryString(queryParameters);
