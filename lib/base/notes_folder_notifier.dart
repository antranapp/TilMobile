...
typedef FolderNotificationCallback = void Function(int index, NotesFolder folder);
typedef FolderRenamedCallback = void Function(NotesFolderFS folder, String oldPath);
typedef NoteNotificationCallback = void Function(int index, Note note);
typedef NoteRenamedCallback = void Function(int index, Note note, String oldPath);
